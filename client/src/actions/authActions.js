import {USER_LOADING,USER_LOADED,AUTH_ERROR,LOGIN_SUCCESS,LOGIN_FAIL,REGISTER_SUCCESS,REGISTER_FAIL,LOGOUT_SUCCESS,USERS_LOADING,USERS_LOADED,CHANGE_USER,SET_CHAT_ONLINE} from '../actions/types';
