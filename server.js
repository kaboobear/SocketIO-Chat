        ...
        .then((newMessageData) => {
          if (data.current_chat.sender._id !== data.author._id) {
            Chat.findOneAndUpdate(
              { _id: data.current_chat._id },
              {
                $set: { lastMessageDate: Date.now() },
                $inc: { unreadTalkerMessages: 1 },
              },
